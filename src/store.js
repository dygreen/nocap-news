...
let comment = createSlice({
  ...
  initialState : [
    ...
    { id: 1, user: 'Liam', date: '2022-06-22', content: '봄바람을 불어 있는 품에 맺어, 위하여 원대하고, 생생하며, 것이다. 되려니와, 물방아 피부가 것은 어디 황금시대다. 찾아다녀도, 그들은 보는 눈이 쓸쓸한 길을 풍부하게 것은 보라. 가치를 거친 있는 투명하되 속잎나고, 트고, 사랑의 이것이다.' },
    { id: 2, user: 'Alicia', date: '2022-08-17', content: '만물은 간에 그들의 넣는 거선의 창공에 용감하고 구하기 오직 힘있다. 너의 바로 꽃이 풀이 풍부하게 이상 들어 그들의 듣는다. 작고 봄날의 내는 이 그들에게 싹이 못할 심장의 것이다.' }
  ]
